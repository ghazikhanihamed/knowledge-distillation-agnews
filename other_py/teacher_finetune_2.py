...
training_args = TrainingArguments(
    output_dir="./results_bert_teacher_improved",
    eval_strategy="epoch",
    learning_rate=3e-5,
    ...
    num_train_epochs=5,
    weight_decay=0.01,
    logging_dir="./logs_bert_teacher_improved",
    logging_steps=200,
    save_strategy="epoch",
    save_total_limit=1,
    seed=42,
...
model.save_pretrained("./bert_teacher_ag_news_improved")
tokenizer.save_pretrained("./bert_teacher_ag_news_improved")
print("Model and tokenizer saved to ./bert_teacher_ag_news_improved")
